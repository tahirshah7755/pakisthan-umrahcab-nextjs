    ...
    async function loadDynamicDropdowns() {
      try {
        ...
        if (Array.isArray(priceListData) && priceListData.length > 0) {
          ...
          // Fallback static array if DB is empty
          setPackagesList([
            "Jeddah Airport to Makkah Hotel ★ (جدہ ایئرپورٹ سے مکہ ہوটل)",
            "Makkah Hotel to Jeddah Airport ★ (مکہ ہوটل سے جدہ ایئرپورٹ)",
            "Jeddah Airport to Madinah Hotel (جدہ ایئرپورٹ سے مدینہ ہوটل)",
