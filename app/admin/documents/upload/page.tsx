...
function DocumentUploadContent() {
  ...
  // If customer is prefilled via URL, fetch customer details
  useEffect(() => {
  ...
  const loadCustomerDocuments = async (customerId: string) => {
    try {
      setLoadingDocs(true);
      const res = await api.getCustomerDocuments(customerId, false);
  ...
  const handleUploadSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await api.uploadCustomerDocument(formData, false);
  ...
  const handleDeleteDoc = async (id: number) => {
    try {
      const res = await api.deleteCustomerDocument(id, false);
      if (res) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "24px", padding: "10px" }}>
      ...
      {/* Header card */}
      <div className="form-header-card" style={{ background: "linear-gradient(135deg, #7c3aed 0%, #5b21b6 100%)", boxShadow: "0 4px 6px -1px rgba(0, 0, 0, 0.1)" }}>
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "6px" }}>
            <h2>Upload Customer Documents</h2>
            <span style={{ background: "#ffffff", color: "#7c3aed", padding: "3px 8px", borderRadius: "12px", fontSize: "11px", fontWeight: "700" }}>B2B & Admin</span>
          </div>
          <p>Attach passport copies, e-visas, vouchers, or ticket images directly to a pilgrim's bio for quick viewing and downloading.</p>
        </div>
        <button onClick={() => router.push(prefilledCustomerId ? `/admin/customers` : `/admin/dashboard`)} className="form-btn-back">
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1.2fr", gap: "24px", alignItems: "start" }}>
        ...
        <div className="form-card" style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
          <h3 style={{ fontSize: "15px", fontWeight: "700", color: "#1e293b", margin: 0, display: "flex", alignItems: "center", gap: "8px" }}>
            <i className="fas fa-file-arrow-up" style={{ color: "#7c3aed" }}></i>
          ...
          <form onSubmit={handleUploadSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            ...
            <div className="form-group">
              <label className="form-label" style={{ fontWeight: 600, color: "#475569" }}>Document Title / Description</label>
              <input
                type="text"
            ...
            {/* File Dropzone */}
            <div className="form-group">
              <label className="form-label" style={{ fontWeight: 600, color: "#475569" }}>Select File</label>
              ...
              >
                ...
                {file ? (
                  <div style={{ textAlign: "center" }}>
                    <p style={{ fontSize: "13px", fontWeight: "700", color: "#1e293b", margin: "0 0 4px 0" }}>
                      Selected: {file.name}
                    </p>
        ...
        <div className="form-card" style={{ display: "flex", flexDirection: "column", gap: "20px", minHeight: "360px" }}>
          <h3 style={{ fontSize: "15px", fontWeight: "700", color: "#1e293b", margin: 0, display: "flex", alignItems: "center", gap: "8px" }}>
            <i className="fas fa-folder-open" style={{ color: "#7c3aed" }}></i>
          ...
          {!selectedCustomer ? (
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", flex: 1, padding: "40px" }}>
              <div className="spinner" style={{ width: "32px", height: "32px", borderWidth: "3px", borderTopColor: "#7c3aed", marginBottom: "12px" }}></div>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                      ...
                      <div style={{ display: "flex", flexDirection: "column" }}>
                        ...
                        <span style={{ fontSize: "11px", color: "#64748b", marginTop: "2px" }}>
                          Uploaded by {doc.uploaded_by || "Admin"} • {new Date(doc.created_at).toLocaleDateString()}
                        </span>
                      </div>
                    </div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                ...
                <div>
                  ...
                  <p style={{ margin: "2px 0 0 0", fontSize: "11px", color: "#64748b" }}>
                    Type: {viewerDoc.file_type?.toUpperCase()} • Uploaded by {viewerDoc.uploaded_by || "Admin"}
                  </p>
                </div>
              </div>
              <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
  ...
  return (
    <Suspense fallback={
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", minHeight: "300px" }}>
        <div className="spinner" style={{ width: "32px", height: "32px", borderWidth: "3px", borderTopColor: "#7c3aed" }}></div>
      </div>
    }>
