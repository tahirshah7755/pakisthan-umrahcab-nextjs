...
const calculateTotalAmount = (payments: any[]) => {
  ...
  return payments.reduce((acc: number, p: any) => {
    ...
    const isAutoGeneratedDue = methodLower === "loan due" || proofLower.includes("auto-generated loan due");
    if (isAutoGeneratedDue) {
      return acc;
    }
              ...
              <tfoot>
                <tr style={{ background: "#f8fafc", fontWeight: "bold", borderTop: "2px solid #e2e8f0" }}>
                  ...
                  <td style={{ padding: "12px 10px", color: "#059669" }}>
                    {fmt(calculateTotalAmount(paginatedPayments))}
                  </td>
                  <td colSpan={4}></td>
                </tr>
                <tr style={{ background: "#f1f5f9", fontWeight: "bold", borderTop: "1px solid #cbd5e1" }}>
                  ...
                  <td style={{ padding: "12px 10px", color: "#0d9488" }}>
                    {fmt(calculateTotalAmount(allPayments))}
                  </td>
                  <td colSpan={4}></td>
                </tr>
              </tfoot>
