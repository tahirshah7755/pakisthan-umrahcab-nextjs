  ...
  useEffect(() => {
    const delayDebounceFn = setTimeout(async () => {
      try {
        ...
        // Call backend API with search query, current page, and 10 per page
        ...
        setCustomersList((prev) => {
          if (page === 1) {
            ...
            // Append new items and prevent any duplicate IDs
    ...
    }, page === 1 ? 300 : 0); // Debounce typing (page 1) by 300ms, load instant scroll pages instantly!
              ...
              >
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <input
                    ...
                    autoFocus
                    onClick={(e) => e.stopPropagation()} // prevent closing panel on input click
                  />
                </div>
                ...
                <div
                  ...
                  onScroll={(e) => {
                    ...
                    // Trigger load of next page if scrolled to bottom
